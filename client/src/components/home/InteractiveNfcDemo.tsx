      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-7 flex justify-center relative">
            ...
            {/* Phone Body */}
            <div className="w-full max-w-[300px] xs:max-w-[340px] sm:max-w-[360px] bg-slate-100 rounded-[44px] sm:rounded-[48px] p-3 sm:p-3.5 shadow-2xl border-4 border-slate-300 relative ring-1 ring-slate-200 mx-auto">
