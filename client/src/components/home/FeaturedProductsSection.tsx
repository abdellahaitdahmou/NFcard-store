                    ...
                    <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-100 space-y-2">
                      ...
                      <div className="pt-2 border-t border-slate-200/60 flex items-center justify-between text-xs">
                        ...
                        {prod.stockQuantity !== undefined && prod.stockQuantity <= 0 ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-amber-50 text-amber-800 border border-amber-200 animate-pulse">
                ...
                <div className="p-5 sm:p-6 pt-0 space-y-2 border-t border-slate-100">
                  {prod.stockQuantity !== undefined && prod.stockQuantity <= 0 ? (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl font-bold text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 transition-all"
                    >
